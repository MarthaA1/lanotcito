...
// script de funciomes y configuración de la vista y funciones de los elementos del mapa

//window.alert("mapa_funcion.js")
...
const initialize = (mapid, token) => {
    ...
    const map = new google.maps.Map(document.getElementById('map_gee'), mapOptions);
